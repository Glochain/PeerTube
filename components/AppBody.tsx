...
const AppBody: React.FC<Props> = ({ state, setApiKey, createStream }) => {
  ...
  switch (state.appState) {
    ...
    case APP_STATES.SHOW_VIDEO:
      ...
      return (
        <div className="container w-full flex flex-col items-center overflow-auto pb-20">

          <div className="relative bg-black h-56 lg:h-96 w-full xl:w-3/5 overflow-hidden mt-20">
