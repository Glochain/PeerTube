...
export class NFTMarketplace__fetchItemsListedResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
...
export class NFTMarketplace__fetchMarketItemsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class NFTMarketplace__fetchMyNFTsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class NFTMarketplace extends ethereum.SmartContract {
  ...
  fetchItemsListed(): Array<
    NFTMarketplace__fetchItemsListedResultValue0Struct
  > {
  ...
  try_fetchItemsListed(): ethereum.CallResult<
    Array<NFTMarketplace__fetchItemsListedResultValue0Struct>
  > {
  ...
  fetchMarketItems(): Array<
    NFTMarketplace__fetchMarketItemsResultValue0Struct
  > {
    let result = super.call(
      "fetchMarketItems",
  ...
  try_fetchMarketItems(): ethereum.CallResult<
    Array<NFTMarketplace__fetchMarketItemsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMarketItems",
      "fetchMarketItems():((uint256,address,address,uint256,bool)[])",
  ...
  fetchMyNFTs(): Array<NFTMarketplace__fetchMyNFTsResultValue0Struct> {
    let result = super.call(
      "fetchMyNFTs",
    ...
    return result[0].toTupleArray<
      NFTMarketplace__fetchMyNFTsResultValue0Struct
    >();
  }

  try_fetchMyNFTs(): ethereum.CallResult<
    Array<NFTMarketplace__fetchMyNFTsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMyNFTs",
      "fetchMyNFTs():((uint256,address,address,uint256,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<NFTMarketplace__fetchMyNFTsResultValue0Struct>()
    );
  }
